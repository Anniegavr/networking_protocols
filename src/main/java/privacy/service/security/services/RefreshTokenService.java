...
import privacy.dao.RefreshTokenRepository;
...
public class RefreshTokenService {
    ...
    @Transactional
    public int deleteByOwnerId(Long userId) {
        return refreshTokenRepository.deleteByOwner(userRepository.findById(userId).get());
    }
}
